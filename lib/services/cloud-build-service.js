...
class CloudBuildService {
    ...
    uploadFileToS3(projectId, localFilePath) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getiOSBuildProperties(projectSettings, buildProps, iOSBuildData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const provisonS3Data = yield this.uploadFileToS3(projectSettings.projectId, iOSBuildData.pathToProvision);
    ...
    getCertificateCommonName(certificatePath, certificatePassword) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                pem.readPkcs12(path.resolve(certificatePath), { p12Password: certificatePassword }, (err, obj) => {
                    if (err) {
                        reject(err);
                        return;
                    }
