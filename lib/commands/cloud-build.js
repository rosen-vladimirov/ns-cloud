...
class CloudBuild {
    ...
    execute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.$cloudBuildService.build(projectSettings, platform, buildConfiguration, { pathToCertificate, certificatePassword: this.$options.keyStorePassword }, { pathToCertificate, certificatePassword: this.$options.certificatePassword, pathToProvision, buildForDevice: !this.$options.emulator });
        });
    }
    canExecute(args) {
        return __awaiter(this, void 0, void 0, function* () {
